...
def send_telegram(msg):
    ...
    # Use proper json.dumps to avoid payload breakages
    data = {
...
country_codes = {
    ...
    "51": "🇵🇪 Peru", "52": "🇲🇽 Mexico", "53": "🇨🇺 Cuba", "54": "🇦𝒓 Argentina",
    ...
    "268": "🇸🇿 Eswatini", "269": "🇰🇲 Comoros", "350": "🇬🇮 Gibraltar", "351": "🇵🇹 Portugal",
    ...
    "383": "🇽🇰 Kosovo", "385": "🇭🇷 Croatia", "386": "🇸慢 Slovenia", "387": "🇧🇦 Bosnia",
    "389": "🇲🇰 North Macedonia", "420": "🇨🇿 Czech Republic", "421": "🇸放 Slovakia",
    ...
    "598": "🇺🇾 Uruguay", "670": "🇹🇱 Timor-Leste", "673": "🇧🇳 Brunei", "674": "🇳🇷 Nauru",
...
while True:
    ...
    for panel in PANELS:
        ...
        for entry in entries:
            ...
            otp = extract_otp(msg)
            if not otp:
                # If regex fails but a dedicated field exists, fallback to it
